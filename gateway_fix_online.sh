...
# OpenClaw Gateway 修复脚本 - 在线版本
# 版本: 1.0
# 使用方法: curl -fsSL https://raw.githubusercontent.com/zhengweiyu/openclaw/main/gateway_fix_online.sh | bash

set -euo pipefail

# ==================== 配置 ====================
readonly SCRIPT_VERSION="1.0"
readonly SCRIPT_URL="https://raw.githubusercontent.com/zhengweiyu/openclaw/main/gateway_fix_online.sh"
